...
## Status
**`coord-engine` v0.4.0 + **all six skills built** — reconcile, roles, tasks, review, continuity, automation. **103 engine tests** + a live end-to-end run of reconcile/queries against the real
